...
<body>
    ...
    <!--  -->
    <!-- carousel -->
    <div id="demo" class="carousel slide container mt-3" data-bs-ride="carousel">
        
        <!-- The slideshow/carousel -->
        <div class="carousel-inner">
            <?php while($rowBan = mysqli_fetch_assoc($BanRes)){ ?>
                <div class="carousel-item active">
                    <img src="<?php echo $rowBan['image'] ?>" alt="<?php echo $rowBan['title']?>" class="d-block rounded-1" style="width:100%">
                </div>
            <?php } ?>
    ...
    <div id="sec1">
        <div class="container pb-5">
            <h4 class="mt-5 mb-5">All Products</h4>

            <div class="row">
                <?php while($rowPro = mysqli_fetch_assoc($products)){ ?>
                <div class="col-4 col-md-3 mb-5" id="col-4">
                    <a href="productDetail.php?id=<?php echo urlencode($rowPro['id']); ?>" class="justify-content-around align-items-center d-flex border border-1 rounded-1">
